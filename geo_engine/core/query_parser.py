...
class QueryParser:
    ...
    LENS_KEYWORDS: Dict[str, List[str]] = {
        ...
        "geopolitical": ["power", "alliance", "rivalry", "border", "lac", "loc", "military", "troops", "standoff", "hedging", "security", "aukus", "imec", "i2u2", "quad", "bri", "belt and road"],
        ...
        "hybrid_covert": ["hybrid", "covert", "grey zone", "gray zone", "sabotage", "subversion", "intelligence", "proxy", "espionage", "psyop", "ramming", "shouldering", "bow crossing", "hunain", "pns", "naval standoff", "sub-kinetic", "technical error", "steering failure", "crew error", "inexperience", "diversion", "maskirovka", "competing hypotheses", "ach", "why did it happen"],
