...
class QueryParser:
    ...
    LENS_KEYWORDS: Dict[str, List[str]] = {
        ...
        "geopolitical": ["power", "alliance", "rivalry", "border", "lac", "loc", "military", "troops", "standoff", "hedging", "security", "aukus", "imec", "i2u2", "quad", "bri", "belt and road", "game theory", "red team", "counter-move", "escalation spiral", "wargame campaign", "persistent campaign", "wargame session"],
        "kinesics": ["bodylanguage", "body language", "photoshoot", "photo", "handshake", "posture", "gaze", "facial"],
        "cash_flow": ["cash", "investment", "fdi", "capex", "mou", "currency", "settlement", "money", "vostro", "funding", "npa write-off", "bad loan", "bank recapitalization", "haircut ratio", "ibc resolution", "write-off"],
        "propaganda": ["optics", "narrative", "message", "propaganda", "spin", "media", "watson", "bernays", "behavioral conditioning", "fear marketing", "anxiety capture", "torches of freedom", "mkultra", "mockingbird", "breast-milk substitutes", "teleological", "social engineering", "engineering of consent", "guilt marketing", "psychological warfare"],
        ...
        "food_security": ["food", "fertilizer", "urea", "dap", "mop", "grain", "wheat", "rice", "famine", "buffer stock", "pds", "agriculture", "export ban", "water security", "monsoon", "groundwater", "indus waters", "teesta", "brahmaputra", "potassium", "fertilizer import", "soil nutrient", "fertilizer dependency", "rice ban", "wheat ban", "onion duty", "price stabilization", "farmer income", "anti-farmer"],
